...
<template>
  <div class="-translate-y-1/3">
    <div
      class="mx-auto grid max-w-6xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8 py-8 sm:py-16 lg:py-20 bg-white shadow-md"
    >
      <div
      ...
      <form class="w-full max-w-md lg:col-span-5 lg:pt-2" @submit.prevent>
        <div class="flex gap-x-4">
          <label :for="formId" class="sr-only">Email address</label>
          <input
            :id="formId"
            name="email"
            type="email"
