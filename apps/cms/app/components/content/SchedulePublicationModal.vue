...
const selectedDate = ref(calendarDateFromToday())
...
<template>
  <UModal
    ...
    description="Choisissez le jour de mise en ligne sur le site."
    :ui="{
      content: 'sm:max-w-[24rem]',
      footer: 'flex justify-end gap-2 border-t border-default pt-4',
    }"
  >
    <template #body>
      <div class="space-y-4">
            ...
            <div class="min-w-0 space-y-1">
              ...
              <p class="text-xs leading-relaxed text-muted">
                <template v-if="isPastSlot">
                  Cette date est déjà passée : le contenu sera publié au prochain passage du planificateur (environ 5 minutes).
                </template>
                <template v-else>
